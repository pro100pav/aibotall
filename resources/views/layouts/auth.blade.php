...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Авторизация My-all</title>
        ...
        <div class="container h-100">
            ...
            required placeholder="Логин">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Ваш пароль">
                                        </div>
                                    ...
                                    <div class="new-account mt-3">
                                        <p>Нет аккаунта? <a class="text-primary" href="#">Расскажем как создать</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
